...
sudo docker run \
  ...
  -it \
  -p 8081:8080 \
  -v /mnt/c/Applications/tomcat-docker/tomcat-users.xml:/usr/local/tomcat/conf/tomcat-users.xml \
  -v /mnt/c/Applications/tomcat-docker/context.xml:/tmp/context.xml \
  tomcat:9.0 \
