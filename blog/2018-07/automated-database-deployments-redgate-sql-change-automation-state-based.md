...
4) Make a change and save it to your local Git repo.
5) Push the change to Github and have the build queue the change
6) Wait for the build to complete.  You should now see that change in the database on Dev.
