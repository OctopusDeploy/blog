...
description: How to look at Deployment and Runbook History in Octopus Deploy to analyize and determine your ROI.
...
**Percentage of Planned vs. Actual** - The chart below compares the releases to Development vs. Production. The goal was to see how many project releases were meant to go to Production, but due to either, code issues or bugs had to be re-released before making it to Production.
...
To answer the question of how much has Octopus Deploy saved my company, let's look at the data we now have collected.
...
At a bare minimum, 3,575 hours, and we know it would for sure have taken more time for the larger environments. Manual execution 3,575 hours, but the Octopus Deploy engines automated execution time tool only 53.5 hours.
