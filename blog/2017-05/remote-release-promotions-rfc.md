...
We are aware of customers who instead of either of these features wrote their own migration scripts and process. We have tried to address all methods and concerns that scripted solutions contained in the remote releases feature, so please let us know if you think anything is missing from this feature. Our goal is you would use Remote Release promotions and not have to maintain your own scripts.
