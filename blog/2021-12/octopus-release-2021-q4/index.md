...
- TypeScript API client for Octopus Deploy 1.0.0
- Octopus Deploy for Visual Studio Code 0.0.17
- TeamCity plugin for Octopus Deploy 6.1.5
- Go API client for Octopus Deploy 1.7.49
- Tentacle 6.1.1147
- Terraform Provider for Octopus Deploy 0.7.61
...
Learn more about the [TypeScript API client](https://octopus.com/docs/octopus-rest-api) in our documentation. You can download the client [through npm](https://www.npmjs.com/package/@octopusdeploy/api-client).
...
Learn more in our post [Octopus Deploy Config as Code: Early Access Preview](todo).
