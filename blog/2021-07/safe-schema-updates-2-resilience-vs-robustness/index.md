...
In part 1, we reviewed the common death-spiral associated with traditional attitudes toward database administration and design. Over the next few posts, we’ll explore a few important theoretical concepts that go some-way to explaining why it’s often the most risk-averse organisations who create the most dangerous databases, and we’ll imagine what a safer data architecture and development culture might look like.
...
*[How Complex Systems Fail](https://how.complexsystems.fail/)* is roughly a 10-minute read and, in my personal opinion, it should be mandatory reading for any computer science student or IT professional. In it Cook highlights 18 specific and measurable attributes that are commonplace within mature complex systems:
...
Remember, these are specifically in reference to *unpredictable* complex systems, like the hypothetical database and its dependencies from [the previous post](blog/2021-07/safe-schema-updates-1-delivery-hell).
...
The DevOps movement is often thought of as the evolution of Lean ideas born from the Japanese car manufacturing industry in the 1970s and '80s. Arguably, however, especially in more recent years, DevOps owes as much heritage to the Safety 2.0 movement, pioneered by Cook and his contemporaries. Rather than automobile manufacturing and supply chain management, Safety 2.0 was developed in the health care sector in the '90s and '00s. Safety 2.0 is a management philosophy designed to nurture a 'safety culture' within the sorts of complex systems that Cook described in How Complex Systems Fail. 
...
Practically, what does that look like? Well, it could look like many things. Netflix is often painted ast the poster-child for resilience engineering in IT, so let's discuss what they do.
