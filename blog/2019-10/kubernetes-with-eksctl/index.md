...
Information on installing `kubectl` can be found in the [Kubernetes documentation](https://kubernetes.io/docs/tasks/tools/install-kubectl/#install-kubectl-on-windows), and you can find more information on `aws-iam-authenticator` from the [AWS documentation](https://g.octopushq.com/AWSEKSKubectl).
