...
:::warning
Though the step exists in Bamboo, you still need to install the Node `Executeable` on the build server and define it's location in Bamboo administration -> Executables.
:::
