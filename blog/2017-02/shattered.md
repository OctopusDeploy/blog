...
Either way, SHA1 has been on the way out for some time, and certificate authorities stopped issuing SHA1 certificates quite some time ago. It's just another nail in the coffin, 

In this post, I want to explain what this means for Octopus, as well as people who use Octopus. 
...
Here's a PowerShell script that you can use to check whether a website is using a SHA1 certificate:



And here's one that checks whether your IIS server is using any SHA1 certificates:
