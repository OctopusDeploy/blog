...
-	Can the DBs be built in isolation, or do they need be to built/deployed together, in a certain order? (I’d pray that there aren’t any circular dependencies!)
...
I’m fully aware that this blog post is only a treatment for the symptom, rather than cure underlying problem. And there are side-effects to be aware of.
