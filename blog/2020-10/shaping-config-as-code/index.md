...
Even more than an _automation_ tool, Octopus is a _collaboration_ tool. Having editing a text file as the only way to make changes locks many groups of people out. 
