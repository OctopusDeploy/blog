...
description: Config as Code for Runbooks is coming soon, complementing our existing support for version-controlled deployment processes.
...
We're excited to announce that Configuration as Code for Runbooks is rolling out to our Cloud customers soon. 
...
Config as Code for Runbooks will start rolling out to our Cloud customers soon. The release date for our self-hosted customers will be announced soon, too.
...
Config as Code for Runbooks has been one of our most requested features. We'll be providing more information soon, so stay tuned for updates on our blog, in our newsletter, on social media, and in our docs. 
